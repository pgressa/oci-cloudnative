...
@Context
@Singleton
public class HikariSodaPermissionDatasourceConfigurationListener implements BeanCreatedEventListener<DatasourceConfiguration> {
    private static final Logger LOG = LoggerFactory.getLogger(HikariSodaPermissionDatasourceConfigurationListener.class);
     ...
     */
    public HikariSodaPermissionDatasourceConfigurationListener(@Nullable OracleWalletArchiveProvider walletArchiveProvider, BeanLocator beanLocator) {
